<?php 
    ...
    $what = 'a.id, a.titel, a.teaser, a.afbeelding, DATE_FORMAT(a.geschreven_op, \'%W %d %M %Y om %H:%i\') AS geschreven_op,
             UNIX_TIMESTAMP(a.laatste_wijziging) AS timestamp, a.is_belangrijk, b.voornaam, b.achternaam'; 
    $from='portal_nieuws a
           LEFT JOIN portal_gebruiker AS b ON(b.id = a.geschreven_door)';
    $where='a.actief = 1 AND a.publicatiedatum <= CURDATE() AND (a.archiveerdatum >= CURDATE() OR a.archiveerdatum = 0000-00-00) AND b.actief = 1';
            ...
            if($bestanden['aantal'] > 0){
                 $belangrijk_nieuws[$nieuws['timestamp']] .= '
                    <div class="nieuwsitem_bestanden">
                        <img src="/portal/functions/'.$functie_get.'/css/images/attachment.png" alt="bestanden" title="'.$bestanden['aantal'].' bestanden" />
                    </div>';
            }
            if($fotos['aantal'] > 0){
                 $belangrijk_nieuws[$nieuws['timestamp']] .= '
                    <div class="nieuwsitem_afbeeldingen">
                        <img src="/portal/functions/'.$functie_get.'/css/images/image.png" alt="afbeeldingen" title="'.$fotos['aantal'].' foto\'s" />
                    </div>';
            }
            $belangrijk_nieuws[$nieuws['timestamp']] .='
                ...
                <div class="nieuwsitem_content">
                    <p>';
             if(is_file($_SERVER['DOCUMENT_ROOT'].'/portal/files/nieuws_afbeelding/'.$nieuws['afbeelding'])){
              $belangrijk_nieuws[$nieuws['timestamp']] .=  '
              <a href="#" onclick="toonNieuws('.$nieuws['id'].')">
                <img class="teaser_img" src="/portal/lib/slir/'.slirImage(60,60).'/portal/files/nieuws_afbeelding/'.$nieuws['afbeelding'].'" alt="'.$nieuws['titel'].'" />
              </a>';  
             }
            ...
            //echo "SELECT $what FROM $from WHERE $where";
                ...
                if($reactie_aantal > 0){
                                    ...
                                    <div class="reactie_foto">
                                        <div class="reactie_profiel_pic">
                                                <a href="/profiel/'.$reactie['gebruikersnaam'].'" title="bekijk het profiel">
                                                    <img src="/portal/lib/slir/'.slirImage(50,50).'/portal/files/album/'.$reactie['album'].'/'.$reactie['profielfoto'].'" 
                                ...
                                <div class="reactie_rechts">
                                    <div class="reactie_header">
                                        ...
                                        if($reactie['geschreven_door'] == $login_id || $_SESSION['admin'] == 1){
                                            $belangrijk_nieuws[$nieuws['timestamp']] .= '
                                            <a class="delete" href="/portal/functions/home/includes/home_check.php?action=delete_reactie&reactie_id='.$reactie['id'].'&nieuws_id='.$nieuws['id'].'" title="Verwijder reactie">
                    ...
                    <div id="tijdlijn_reageren">
                        <textarea class="textarea reageren_dicht" onfocus="this.className=\'reageren_open textarea\'" onblur="this.className=\'reageren_dicht textarea\'" id="nieuws_reactie_'.$nieuws['id'].'" cols="50" rows="3"></textarea><button class="button" onmouseover="this.className=\'button btn_hover\'" onmouseout="this.className=\'button\'" onclick="herlaadReactieform('.$nieuws['id'].', \'nieuws\')">Reageer</button>
                    </div>';
                }
    ...
    while($foto = mysql_fetch_array($foto_result)){
        ...
        if($soort['soort'] == 'nieuws'){
            ...
            <div class="nieuwsitem " onmouseover="this.className=\'nieuwsitem_hover\'" onmouseout="this.className=\'nieuwsitem\'">
                ...
                <div class="nieuwsitem_content">
                    <p>
                        <a class="iframe" href="/portal/functions/afbeeldingen/includes/afbeelding_tonen.php?image_id='.$foto['anchor'].'&refer=home">
                            <img class="nieuwsitem_foto" src="/portal/lib/slir/'.slirImage(300,0, 0).'/portal/files/album/'.$foto['album'].'/'.$foto['path'].'" alt="'.$foto['omschrijving'].'">&nbsp;
                        </a>
                    </p>
                </div>
                <!-- <div class="nieuwsitem_next">
            ...
            //echo "SELECT $what FROM $from WHERE $where";
                ...
                if($reactie_aantal > 0){
                    ...
                    <a href="javascript:toggle_reacties('.$foto['anchor'].', \'foto\');" id="toon_reacties" class="tooltip"><h3>Reacties ('.$reactie_aantal.')</h3></a>
                        <div id="foto_reactielijst_'.$foto['anchor'].'" style="display:none;">';
                        while($reactie = mysql_fetch_array($reactie_result)){
                           $normaal_nieuws[$foto['timestamp']] .= '
                           <div class="tijdlijn_reactie '.$class.'" onmouseover="this.className=\'tijdlijn_reactie reactie_hover '.$class.' \'" onmouseout="this.className=\'tijdlijn_reactie '.$class.'\'">
                                <div class="reactie_links">
                                ...
                                <div class="reactie_rechts">
                                    <div class="reactie_header">
                                        ...
                                        if($reactie['geschreven_door'] == $login_id || $_SESSION['admin'] == 1){
                                            $normaal_nieuws[$foto['timestamp']] .= '
                                            <a class="delete" href="/portal/functions/home/includes/home_check.php?action=delete_reactie&reactie_id='.$reactie['id'].'&nieuws_id='.$soort['id'].'" title="Verwijder reactie">
                                                <img src="/portal/functions/home/css/images/delete.png" alt="X" title="Verwijder reactie"> 
                                            </a>';
                                        }              
                                        $normaal_nieuws[$foto['timestamp']] .='
                    ...
                    <div id="tijdlijn_reageren">
                        <textarea class="textarea reageren_dicht" onfocus="this.className=\'reageren_open textarea\'" onblur="this.className=\'reageren_dicht textarea\'" id="foto_reactie_'.$foto['anchor'].'" cols="50" rows="3"></textarea><button class="button" onmouseover="this.className=\'button btn_hover\'" onmouseout="this.className=\'button\'" onclick="herlaadReactieform('.$foto['anchor'].', \'foto\')">Reageer</button>
                    </div>';
                }
        ...
        elseif($soort['soort'] == 'profiel'){
            ...
            <div class="foto " onmouseover="this.className=\'foto_hover\'" onmouseout="this.className=\'foto\'">
                <div class="foto_header">
                    <a class="iframe" href="/portal/functions/afbeeldingen/includes/afbeelding_tonen.php?image_id='.$foto['id'].'">
                ...
                <div class="foto_content">
                    <p>
                        <a class="iframe" href="/portal/functions/afbeeldingen/includes/afbeelding_tonen.php?image_id='.$foto['anchor'].'&refer=home">
                            <img src="/portal/lib/slir/'.slirImage(300,0, 0).'/portal/files/album/'.$foto['album'].'/'.$foto['path'].'" alt="'.$foto['omschrijving'].'">&nbsp;
                        </a>
                    </p>
                </div> '; 
            $what = 'b.id, b.inhoud, DATE_FORMAT(b.geschreven_op, \'%W %d %M %Y om %H:%i\') AS geschreven_op, b.geschreven_door, 
                           ...
                           <div class="tijdlijn_reactie '.$class.'" onmouseover="this.className=\'tijdlijn_reactie reactie_hover '.$class.' \'" onmouseout="this.className=\'tijdlijn_reactie '.$class.'\'">
                                ...
                                <div class="reactie_rechts">
                                    <div class="reactie_header">
                                        ...
                                        if($reactie['geschreven_door'] == $login_id || $_SESSION['admin'] == 1){
                                            $normaal_nieuws[$foto['timestamp']] .= '
                                            <a class="delete" href="/portal/functions/home/includes/home_check.php?action=delete_reactie&reactie_id='.$reactie['id'].'&nieuws_id='.$nieuws_id.'" title="Verwijder reactie">
                                                <img src="/portal/functions/home/css/images/delete.png" alt="X" title="Verwijder reactie"> 
                                            </a>';
                                        }              
                                        $normaal_nieuws[$foto['timestamp']] .='
    ...
    /*
    if(count($nieuws_foto_samenstelling) > 0){
                    foreach($nieuws_foto_samenstelling AS $id => $timestamps){
                        $timestamp_array = explode('x', $timestamps);
                        $aantal_timestamps = count($timestamp_array);
                        
                        $what = 'a.titel,b.voornaam, b.achternaam'; 
                        $from='portal_nieuws a
                        LEFT JOIN portal_gebruiker AS b ON(b.id = a.geschreven_door)';
                        $where='a.id = '.$id.' AND b.actief = 1';
                            $nieuwitem = mysql_fetch_assoc(sqlSelect($what, $from, $where));
                        $normaal_nieuws[$timestamp_array[$aantal_timestamps - 1]] = '
                        <div class="nieuwsitem " onmouseover="this.className=\'nieuwsitem_hover\'" onmouseout="this.className=\'nieuwsitem\'">
                            <div class="nieuwsitem_header">
                                <a href="#" onclick="toonNieuws('.$id.')"><h3>'.$aantal_timestamps.' Nieuwe foto\'s toegevoegd aan '."'".$nieuwitem['titel']."'".'</h3></a>
                                <span class="nieuwsitem_author">geupload door: '.$nieuwitem['voornaam'].' '.$nieuwitem['achternaam'].' - '.strftime('%A %e %B %Y om %H:%M').'</span>
                            </div>
                            <div class="nieuwsitem_next">
                                <a href="#" onclick="toonNieuws('.$id.')">&nbsp;</a>
                            </div> 
                        </div>';
                    }
                }
