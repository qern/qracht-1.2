...
if($_POST['action'] == 'reactie'){
    ...
    if($_POST['reactie'] != null){        
        ...
        $table = 'portal_nieuws_reactie';
        $what = 'nieuws, reactie';
        $with_what= $_POST['nieuws_id'].', (SELECT MAX(id) FROM portal_reactie)';
            $voeg_reactie_toe_aan_nieuws = sqlInsert($table, $what, $with_what);
            
        $table ="portal_nieuws"; $what = 'update_datum = NOW()'; $where = 'id  = '.$_POST['nieuws_id'];
                $update_nieuws = sqlUpdate($table, $what, $where);
    }
    header('location: '.$site_name.'home/nieuws='.$_POST['nieuws_id']);
}
elseif($_POST['action'] == 'reactie_wijzigen'){
    ...
    header('location: '.$site_name.'planning/'.$_POST['refer'].'/activiteit-wijzigen/activiteit-id='.$_POST['activiteit_id']);
}
elseif($_GET['action'] == 'delete_reactie'){
    ...
    header('location: '.$site_name.'home/nieuws='.$_GET['nieuws_id']);
}
